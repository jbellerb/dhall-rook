λ(kubernetes : ./kubernetes.dhall) →
  ...
  , AddressRangesSpec =
      ./defaults/io.rook.ceph.v1.AddressRangesSpec.dhall kubernetes
  , AuthSpec = ./defaults/io.rook.ceph.v1.AuthSpec.dhall kubernetes
  ...
  , CSICephFSSpec = ./defaults/io.rook.ceph.v1.CSICephFSSpec.dhall kubernetes
  , CSIDriverSpec = ./defaults/io.rook.ceph.v1.CSIDriverSpec.dhall kubernetes
  ...
  , CephCOSIDriver = ./defaults/io.rook.ceph.v1.CephCOSIDriver.dhall kubernetes
  , CephCOSIDriverList =
      ./defaults/io.rook.ceph.v1.CephCOSIDriverList.dhall kubernetes
  , CephCOSIDriverSpec =
      ./defaults/io.rook.ceph.v1.CephCOSIDriverSpec.dhall kubernetes
  ...
  , CephExporterSpec =
      ./defaults/io.rook.ceph.v1.CephExporterSpec.dhall kubernetes
  ...
  , ConfigFileVolumeSource =
      ./defaults/io.rook.ceph.v1.ConfigFileVolumeSource.dhall kubernetes
  , ConnectionsSpec =
  ...
  , KerberosConfigFiles =
      ./defaults/io.rook.ceph.v1.KerberosConfigFiles.dhall kubernetes
  , KerberosKeytabFile =
      ./defaults/io.rook.ceph.v1.KerberosKeytabFile.dhall kubernetes
  , KerberosSpec = ./defaults/io.rook.ceph.v1.KerberosSpec.dhall kubernetes
  , KeyManagementServiceSpec =
      ./defaults/io.rook.ceph.v1.KeyManagementServiceSpec.dhall kubernetes
  , KeyRotationSpec =
      ./defaults/io.rook.ceph.v1.KeyRotationSpec.dhall kubernetes
  , KeystoneSpec = ./defaults/io.rook.ceph.v1.KeystoneSpec.dhall kubernetes
  , LogCollectorSpec =
  ...
  , ModuleSettings = ./defaults/io.rook.ceph.v1.ModuleSettings.dhall kubernetes
  , MonSpec = ./defaults/io.rook.ceph.v1.MonSpec.dhall kubernetes
  , MonZoneSpec = ./defaults/io.rook.ceph.v1.MonZoneSpec.dhall kubernetes
  ...
  , NFSSecuritySpec =
      ./defaults/io.rook.ceph.v1.NFSSecuritySpec.dhall kubernetes
  , NamedBlockPoolSpec =
  ...
  , OSDStatus = ./defaults/io.rook.ceph.v1.OSDStatus.dhall kubernetes
  , OSDStore = ./defaults/io.rook.ceph.v1.OSDStore.dhall kubernetes
  , ObjectEndpointSpec =
      ./defaults/io.rook.ceph.v1.ObjectEndpointSpec.dhall kubernetes
  , ObjectEndpoints =
      ./defaults/io.rook.ceph.v1.ObjectEndpoints.dhall kubernetes
  ...
  , PoolPlacementSpec =
      ./defaults/io.rook.ceph.v1.PoolPlacementSpec.dhall kubernetes
  , PoolSpec = ./defaults/io.rook.ceph.v1.PoolSpec.dhall kubernetes
  , ProbeSpec = ./defaults/io.rook.ceph.v1.ProbeSpec.dhall kubernetes
  , ProtocolSpec = ./defaults/io.rook.ceph.v1.ProtocolSpec.dhall kubernetes
  ...
  , ReadAffinitySpec =
      ./defaults/io.rook.ceph.v1.ReadAffinitySpec.dhall kubernetes
  , ReplicatedSpec = ./defaults/io.rook.ceph.v1.ReplicatedSpec.dhall kubernetes
  , S3Spec = ./defaults/io.rook.ceph.v1.S3Spec.dhall kubernetes
  , SSSDSidecar = ./defaults/io.rook.ceph.v1.SSSDSidecar.dhall kubernetes
  , SSSDSidecarConfigFile =
      ./defaults/io.rook.ceph.v1.SSSDSidecarConfigFile.dhall kubernetes
  , SSSDSpec = ./defaults/io.rook.ceph.v1.SSSDSpec.dhall kubernetes
  , SanitizeDisksSpec =
  ...
  , SwiftSpec = ./defaults/io.rook.ceph.v1.SwiftSpec.dhall kubernetes
  , TopicEndpointSpec =
      ./defaults/io.rook.ceph.v1.TopicEndpointSpec.dhall kubernetes
  , VolumeClaimTemplate =
      ./defaults/io.rook.ceph.v1.VolumeClaimTemplate.dhall kubernetes
