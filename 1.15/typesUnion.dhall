λ(kubernetes : ./kubernetes.dhall) →
  ...
  | AuthSpec : ./types/io.rook.ceph.v1.AuthSpec.dhall kubernetes
  ...
  | CephExporterSpec : ./types/io.rook.ceph.v1.CephExporterSpec.dhall kubernetes
  ...
  | KeystoneSpec : ./types/io.rook.ceph.v1.KeystoneSpec.dhall kubernetes
  ...
  | ModuleSettings : ./types/io.rook.ceph.v1.ModuleSettings.dhall kubernetes
  ...
  | ObjectEndpointSpec :
      ./types/io.rook.ceph.v1.ObjectEndpointSpec.dhall kubernetes
  ...
  | ObjectSharedPoolsSpec :
      ./types/io.rook.ceph.v1.ObjectSharedPoolsSpec.dhall kubernetes
  | ObjectStoreHostingSpec :
      ./types/io.rook.ceph.v1.ObjectStoreHostingSpec.dhall kubernetes
  ...
  | PlacementStorageClassSpec :
      ./types/io.rook.ceph.v1.PlacementStorageClassSpec.dhall kubernetes
  | PoolMirroringInfo :
  ...
  | PoolPlacementSpec :
      ./types/io.rook.ceph.v1.PoolPlacementSpec.dhall kubernetes
  | PoolSpec : ./types/io.rook.ceph.v1.PoolSpec.dhall kubernetes
  | ProbeSpec : ./types/io.rook.ceph.v1.ProbeSpec.dhall kubernetes
  | ProtocolSpec : ./types/io.rook.ceph.v1.ProtocolSpec.dhall kubernetes
  ...
  | S3Spec : ./types/io.rook.ceph.v1.S3Spec.dhall kubernetes
  ...
  | SwiftSpec : ./types/io.rook.ceph.v1.SwiftSpec.dhall kubernetes
  | TopicEndpointSpec :
