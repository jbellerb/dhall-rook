λ(kubernetes : ./kubernetes.dhall) →
  ...
  , AdditionalVolumeMount =
      ./schemas/io.rook.ceph.v1.AdditionalVolumeMount.dhall kubernetes
  , AddressRangesSpec =
      ./schemas/io.rook.ceph.v1.AddressRangesSpec.dhall kubernetes
  , AuthSpec = ./schemas/io.rook.ceph.v1.AuthSpec.dhall kubernetes
  ...
  , CSICephFSSpec = ./schemas/io.rook.ceph.v1.CSICephFSSpec.dhall kubernetes
  , CSIDriverSpec = ./schemas/io.rook.ceph.v1.CSIDriverSpec.dhall kubernetes
  ...
  , CephExporterSpec =
      ./schemas/io.rook.ceph.v1.CephExporterSpec.dhall kubernetes
  ...
  , CephFilesystemSubVolumeGroupSpecPinning =
      ./schemas/io.rook.ceph.v1.CephFilesystemSubVolumeGroupSpecPinning.dhall
        kubernetes
  ...
  , KeystoneSpec = ./schemas/io.rook.ceph.v1.KeystoneSpec.dhall kubernetes
  , LogCollectorSpec =
  ...
  , ModuleSettings = ./schemas/io.rook.ceph.v1.ModuleSettings.dhall kubernetes
  ...
  , ObjectEndpointSpec =
      ./schemas/io.rook.ceph.v1.ObjectEndpointSpec.dhall kubernetes
  ...
  , ObjectSharedPoolsSpec =
      ./schemas/io.rook.ceph.v1.ObjectSharedPoolsSpec.dhall kubernetes
  , ObjectStoreHostingSpec =
      ./schemas/io.rook.ceph.v1.ObjectStoreHostingSpec.dhall kubernetes
  ...
  , PlacementStorageClassSpec =
      ./schemas/io.rook.ceph.v1.PlacementStorageClassSpec.dhall kubernetes
  , PoolMirroringInfo =
  ...
  , PoolPlacementSpec =
      ./schemas/io.rook.ceph.v1.PoolPlacementSpec.dhall kubernetes
  , PoolSpec = ./schemas/io.rook.ceph.v1.PoolSpec.dhall kubernetes
  , ProbeSpec = ./schemas/io.rook.ceph.v1.ProbeSpec.dhall kubernetes
  , ProtocolSpec = ./schemas/io.rook.ceph.v1.ProtocolSpec.dhall kubernetes
  ...
  , ReadAffinitySpec =
      ./schemas/io.rook.ceph.v1.ReadAffinitySpec.dhall kubernetes
  , ReplicatedSpec = ./schemas/io.rook.ceph.v1.ReplicatedSpec.dhall kubernetes
  , S3Spec = ./schemas/io.rook.ceph.v1.S3Spec.dhall kubernetes
  ...
  , SwiftSpec = ./schemas/io.rook.ceph.v1.SwiftSpec.dhall kubernetes
  , TopicEndpointSpec =
      ./schemas/io.rook.ceph.v1.TopicEndpointSpec.dhall kubernetes
  , VolumeClaimTemplate =
      ./schemas/io.rook.ceph.v1.VolumeClaimTemplate.dhall kubernetes
